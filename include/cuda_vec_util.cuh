...
* \{
*/
void remove(ssrlcv::Unity<float2_b>* array);
void remove(ssrlcv::Unity<float3_b>* array);
void remove(ssrlcv::Unity<float4_b>* array);
void remove(ssrlcv::Unity<double2_b>* array);
void remove(ssrlcv::Unity<double3_b>* array);
void remove(ssrlcv::Unity<double4_b>* array);
void remove(ssrlcv::Unity<char2_b>* array);
void remove(ssrlcv::Unity<char3_b>* array);
void remove(ssrlcv::Unity<char4_b>* array);
void remove(ssrlcv::Unity<uchar2_b>* array);
void remove(ssrlcv::Unity<uchar3_b>* array);
void remove(ssrlcv::Unity<uchar4_b>* array);
void remove(ssrlcv::Unity<short2_b>* array);
void remove(ssrlcv::Unity<short3_b>* array);
void remove(ssrlcv::Unity<short4_b>* array);
void remove(ssrlcv::Unity<ushort2_b>* array);
void remove(ssrlcv::Unity<ushort3_b>* array);
void remove(ssrlcv::Unity<ushort4_b>* array);
void remove(ssrlcv::Unity<int2_b>* array);
void remove(ssrlcv::Unity<int3_b>* array);
void remove(ssrlcv::Unity<int4_b>* array);
void remove(ssrlcv::Unity<uint2_b>* array);
void remove(ssrlcv::Unity<uint3_b>* array);
void remove(ssrlcv::Unity<uint4_b>* array);
void remove(ssrlcv::Unity<long2_b>* array);
void remove(ssrlcv::Unity<long3_b>* array);
void remove(ssrlcv::Unity<long4_b>* array);
void remove(ssrlcv::Unity<ulong2_b>* array);
void remove(ssrlcv::Unity<ulong3_b>* array);
void remove(ssrlcv::Unity<ulong4_b>* array);
void remove(ssrlcv::Unity<longlong2_b>* array);
void remove(ssrlcv::Unity<longlong3_b>* array);
void remove(ssrlcv::Unity<longlong4_b>* array);
void remove(ssrlcv::Unity<ulonglong2_b>* array);
void remove(ssrlcv::Unity<ulonglong3_b>* array);
void remove(ssrlcv::Unity<ulonglong4_b>* array);
/**
* \}
* \ingroup cuda_util

...
* \{
*/
void remove(std::shared_ptr<ssrlcv::Unity<float2_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<float3_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<float4_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<double2_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<double3_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<double4_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<char2_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<char3_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<char4_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<uchar2_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<uchar3_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<uchar4_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<short2_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<short3_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<short4_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<ushort2_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<ushort3_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<ushort4_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<int2_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<int3_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<int4_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<uint2_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<uint3_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<uint4_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<long2_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<long3_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<long4_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<ulong2_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<ulong3_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<ulong4_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<longlong2_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<longlong3_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<longlong4_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<ulonglong2_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<ulonglong3_b>> array);
void remove(std::shared_ptr<ssrlcv::Unity<ulonglong4_b>> array);
/**
* \}
* \ingroup cuda_util

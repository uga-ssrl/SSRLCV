...
namespace ssrlcv{
  ...
  */
  struct SIFT_Descriptor{
    ...
    * \see MatchFactory
    */
    __device__ __host__ float distProtocol(const SIFT_Descriptor& b, const float &bestMatch = FLT_MAX) override;
    /**
  ...
  struct Window_3x3{
    ...
    __device__ __host__ float distProtocol(const Window_3x3& b, const float &bestMatch = FLT_MAX) override;
  };
  struct Window_9x9{
    ...
    //distance here is sum of absolute differences
    __device__ __host__ float distProtocol(const Window_9x9& b, const float &bestMatch = FLT_MAX) override;
  };
  struct Window_15x15{
    ...
    //distance here is sum of absolute differences
    __device__ __host__ float distProtocol(const Window_15x15& b, const float &bestMatch = FLT_MAX) override;
  };
  struct Window_25x25{
    ...
    //distance here is sum of absolute differences
    __device__ __host__ float distProtocol(const Window_25x25& b, const float &bestMatch = FLT_MAX) override;
  };
  struct Window_31x31{
    ...
    //distance here is sum of absolute differences
    __device__ __host__ float distProtocol(const Window_31x31& b, const float &bestMatch = FLT_MAX) override;
  };
  /** 
  * \} 
  */

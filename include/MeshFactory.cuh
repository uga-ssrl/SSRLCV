...
namespace ssrlcv{
  ...
  */
  ...
  public:
    ...
    std::shared_ptr<float3> surfaceVertices;
    int numSurfaceVertices;
    std::shared_ptr<int3> surfaceTriangles;
    int numSurfaceTriangles;
    std::shared_ptr<float> vertexImplicitDevice;
    ...
    MeshFactory(std::shared_ptr<ssrlcv::Unity<float3>> in_points, std::shared_ptr<ssrlcv::Unity<int>> in_faces, int in_faceEncoding);
     ...
     */
    MeshFactory(std::shared_ptr<Octree> octree);
     ...
     */
    void setPoints(std::shared_ptr<ssrlcv::Unity<float3>> pointcloud);
     ...
     */
    void setFaces(std::shared_ptr<ssrlcv::Unity<int>> faces, int faceEncoding);
    ...
    */
     ...
     */
    float calculateAverageDifference(std::shared_ptr<ssrlcv::Unity<float3>> pointCloud, float3 planeNormal);
     ...
     */
    std::shared_ptr<ssrlcv::Unity<float>> calculatePerPointDifference(std::shared_ptr<ssrlcv::Unity<float3>> pointCloud, float3 planeNormal);
     ...
     */
    std::shared_ptr<ssrlcv::Unity<float>> calculateAverageDistancesToOctreeNeighbors(int n);
     ...
     * @return float a unity of floats representing the average distance to N neighbors
     */
    std::shared_ptr<ssrlcv::Unity<float>> calculateAverageDistancesToNeighbors(int n);

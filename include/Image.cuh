...
namespace ssrlcv{
  ...
  */
  ...
  public:
    ...
    */
    ...
    std::shared_ptr<ssrlcv::Unity<unsigned char>> pixels;///<\brief pixels of image flattened row-wise
    ...
    */
    ...
    Image(uint2 size, unsigned int colorDepth, std::shared_ptr<ssrlcv::Unity<unsigned char>> pixels);
    /**
    ...
    * \returns std::shared_ptr<ssrlcv::Unity<int2>> gradients in the form of {x,y}
    * \see generatePixelGradients
    * \see Unity
    */
    std::shared_ptr<ssrlcv::Unity<int2>> getPixelGradients();
    /**
    ...
    */
    std::shared_ptr<ssrlcv::Unity<float>> getFloatVector();
    ...
    * @returns array of floats representing the camera parameters in the order X pos, Y pos, Z pos, X rot, Y rot, Z rot, fov X, fov Y, foc, dpix x, dpix y
    */
    std::shared_ptr<ssrlcv::Unity<float>> getFloatVector(int len);
    ...
    */
    void setFloatVector(std::shared_ptr<ssrlcv::Unity<float>> params);
    ...
    */
    std::shared_ptr<ssrlcv::Unity<float>> getExtrinsicDifference(Camera other);
  ...
  * \returns std::shared_ptr<ssrlcv::Unity<unsigned char>> of pixels with border applied flattened row-wise
  * \see Unity
  */
  std::shared_ptr<ssrlcv::Unity<unsigned char>> addBufferBorder(uint2 size, std::shared_ptr<ssrlcv::Unity<unsigned char>> pixels, int2 border);
  /**
  * \brief Generate a new image with a border.
  * \details This method takes in a Unity<unsigned char> pixel array and will add
  * a border to it. If the border is positive, it will return a larger image
  ...
  * \see Unity
  */
  std::shared_ptr<ssrlcv::Unity<float>> addBufferBorder(uint2 size, std::shared_ptr<ssrlcv::Unity<float>> pixels, int2 border);
  /**
  * \brief Convert std::shared_ptr<ssrlcv::Unity<float>> to std::shared_ptr<ssrlcv::Unity<unsigned char>>
  ...
  */
  std::shared_ptr<ssrlcv::Unity<unsigned char>> convertImageToChar(std::shared_ptr<ssrlcv::Unity<float>> pixels);
  /**
  * \brief Convert std::shared_ptr<ssrlcv::Unity<unsigned char>> to std::shared_ptr<ssrlcv::Unity<float>>
  ...
  */
  std::shared_ptr<ssrlcv::Unity<float>> convertImageToFlt(std::shared_ptr<ssrlcv::Unity<unsigned char>> pixels);
  /**
  * \brief Normalize float values in Unity from 0-1.
  * \details This method will determine min and max for the values
  * in the std::shared_ptr<ssrlcv::Unity<float>> and then normalize between 0 and 1.
  * \param pixels - float values
  * \see Unity
  * \see normalize(unsigned long, float*, float2)
  * \todo add option to normalize between two numbers
  */
  void normalizeImage(std::shared_ptr<ssrlcv::Unity<float>> pixels);
  /**
  * \brief Normalize float values in Unity from 0-1.
  ...
  * be incorrect
  */
  void normalizeImage(std::shared_ptr<ssrlcv::Unity<float>> pixels, float2 minMax);
  /**
  ...
  * \see generateBW
  */
  void convertToBW(std::shared_ptr<ssrlcv::Unity<unsigned char>> pixels, unsigned int colorDepth);
  /**
  ...
  */
  void convertToRGB(std::shared_ptr<ssrlcv::Unity<unsigned char>> pixels, unsigned int colorDepth);
  ...
  * \returns std::shared_ptr<ssrlcv::Unity<int2>> that has gradients {x,y} stored in same order as pixel
  * \see Unity
  ...
  */
  std::shared_ptr<ssrlcv::Unity<int2>> generatePixelGradients(uint2 imageSize, std::shared_ptr<ssrlcv::Unity<unsigned char>> pixels);
  /**
  ...
  * \param imageSize - {width,height} of image
  * \param pixels - pixels of image flattened row-wise.
  * \returns std::shared_ptr<ssrlcv::Unity<float2>> that has gradients {x,y} stored in same order as pixel
  * \see Unity
  * \see calculatePixelGradients(uint2,float*,int2*)
  * \note No need to pass in colorDepth as that can be determined by
  * looking at numElements of pixels and size of image.
  */
  std::shared_ptr<ssrlcv::Unity<float2>> generatePixelGradients(uint2 imageSize, std::shared_ptr<ssrlcv::Unity<float>> pixels);
  ...
  * \see Unity
  * \see addBufferBorder(uint2,std::shared_ptr<ssrlcv::Unity<unsigned char>>,int2)
  * \note No need to pass in colorDepth as that can be determined by
  * looking at numElements of pixels and size of image.
  */
  void makeBinnable(uint2 &size, std::shared_ptr<ssrlcv::Unity<unsigned char>> pixels, int plannedDepth);
  /**
  ...
  * \param plannedDepth - the number of times the image will be binned
  * \see Unity
  * \see addBufferBorder(uint2,std::shared_ptr<ssrlcv::Unity<float>>,int2)
  * \note No need to pass in colorDepth as that can be determined by
  * looking at numElements of pixels and size of image.
  */
  void makeBinnable(uint2 &size, std::shared_ptr<ssrlcv::Unity<float>> pixels, int plannedDepth);
  ...
  * \param imageSize - {width,height} of image
  * \param pixels - pixels of image flattened row-wise
  * \returns - std::shared_ptr<ssrlcv::Unity<unsigned char>> holding the binned version of the provided image
  * \see Unity
  * \see binImage(uint2,unsigned int,unsigned char*,unsigned char*)
  * \note No need to pass in colorDepth as that can be determined by
  * looking at numElements of pixels and size of image.
  */
  std::shared_ptr<ssrlcv::Unity<unsigned char>> bin(uint2 imageSize, std::shared_ptr<ssrlcv::Unity<unsigned char>> pixels);
  /**
  ...
  * \param imageSize - {width,height} of image
  * \param pixels - pixels of image flattened row-wise
  * \returns - std::shared_ptr<ssrlcv::Unity<float>> holding the binned version of the provided image
  * \see Unity
  * \see binImage(uint2,unsigned int,float*,float*)
  * \note No need to pass in colorDepth as that can be determined by
  * looking at numElements of pixels and size of image.
  */
  std::shared_ptr<ssrlcv::Unity<float>> bin(uint2 imageSize, std::shared_ptr<ssrlcv::Unity<float>> pixels);
  ...
  * \param imageSize - {width,height} of image
  * \param pixels - pixels of image flattened row-wise
  * \returns - std::shared_ptr<ssrlcv::Unity<unsigned char>> holding the upsampled version of the provided image
  * \see Unity
  * \see upsampleImage(uint2,unsigned int,unsigned char*,unsigned char*)
  * \note No need to pass in colorDepth as that can be determined by
  * looking at numElements of pixels and size of image.
  */
  std::shared_ptr<ssrlcv::Unity<unsigned char>> upsample(uint2 imageSize, std::shared_ptr<ssrlcv::Unity<unsigned char>> pixels);  /**
  * \brief Upsample an float image by a factor of 2.
  * \details This method will generate an image from a provided image that
  * is double the width and half height of the original image.
  * \param imageSize - {width,height} of image
  * \param pixels - pixels of image flattened row-wise
  * \returns - std::shared_ptr<ssrlcv::Unity<float>> holding the upsampled version of the provided image
  * \see Unity
  * \see upsampleImage(uint2,unsigned int,float*,float*)
  * \note No need to pass in colorDepth as that can be determined by
  * looking at numElements of pixels and size of image.
  */
  std::shared_ptr<ssrlcv::Unity<float>> upsample(uint2 imageSize, std::shared_ptr<ssrlcv::Unity<float>> pixels);
  ...
  * \returns - std::shared_ptr<ssrlcv::Unity<unsigned char>> holding the scaled version of the provided image
  * \see Unity
  * \see bilinearInterpolation(uint2,unsigned int,unsigned char*,unsigned char*,float)
  * \note No need to pass in colorDepth as that can be determined by
  * looking at numElements of pixels and size of image.
  */
  std::shared_ptr<ssrlcv::Unity<unsigned char>> scaleImage(uint2 imageSize, std::shared_ptr<ssrlcv::Unity<unsigned char>> pixels, float outputPixelWidth);
  /**
  ...
  * \param pixels - pixels of image flattened row-wise
  * \param outputPixelWidth - the desired size of a pixel in the returned Unity
  * \returns - std::shared_ptr<ssrlcv::Unity<float>> holding the scaled version of the provided image
  * \see Unity
  * \see bilinearInterpolation(uint2,unsigned int,float*,float*,float)
  * \note No need to pass in colorDepth as that can be determined by
  * looking at numElements of pixels and size of image.
  */
  std::shared_ptr<ssrlcv::Unity<float>> scaleImage(uint2 imageSize, std::shared_ptr<ssrlcv::Unity<float>> pixels, float outputPixelWidth);


  /**
  * \brief Convolve an unsigned char image with a specified kernel.
  * \details This method will convolve and image with a provided
  * kernel and return a std::shared_ptr<ssrlcv::Unity<float>> containing the convolved image. There
  ...
  * \see Unity
  */
  std::shared_ptr<ssrlcv::Unity<float>> convolve(uint2 imageSize, std::shared_ptr<ssrlcv::Unity<unsigned char>> pixels, int2 kernelSize, float* kernel, bool symmetric = true);
  /**
  ...
  * \see Unity
  */
  std::shared_ptr<ssrlcv::Unity<float>> convolve(uint2 imageSize, std::shared_ptr<ssrlcv::Unity<float>> pixels, int2 kernelSize, float* kernel, bool symmetric = true);

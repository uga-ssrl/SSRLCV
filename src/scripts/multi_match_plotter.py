...
def main(argv):
    ...
    image0 = 'data/img/multiview_test/Lenna_512.png'
    image1 = 'data/img/multiview_test/Lenna_512(3).png'
    image2 = 'data/img/multiview_test/Lenna_512(1).png'
    image3 = 'data/img/multiview_test/Lenna_512(2).png'
    numMatches = 1
      ...
      for v in range(numKP - 1):
        if(verts[v] == 'left_up'):
          if(verts[v+1] == 'right_up'):
            con = patches.ConnectionPatch(xyA=right_up, xyB=left_up, coordsA="data", coordsB="data", axesA=a2, axesB=a1, color="red")
            a2.add_artist(con)
          ...
          if(verts[v+1] == 'right_down'):
            con = patches.ConnectionPatch(xyA=right_down, xyB=right_up, coordsA="data", coordsB="data", axesA=a3, axesB=a2, color="red")
            a3.add_artist(con)
          else:  
          ...
          con = patches.ConnectionPatch(xyA=left_down, xyB=right_down, coordsA="data", coordsB="data", axesA=a4, axesB=a3, color="red")
          a3.add_artist(con)

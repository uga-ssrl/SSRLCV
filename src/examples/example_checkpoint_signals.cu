...
template<typename T>
bool printTest(ssrlcv::ptr::value<ssrlcv::Unity<T>> original, ssrlcv::ptr::value<ssrlcv::Unity<T>> checkpoint){
    bool passed = true;
...
ssrlcv::ptr::value<ssrlcv::Unity<int>> i_nums;
ssrlcv::ptr::value<ssrlcv::Unity<int>> i_nums_cpt;
...
void sigintHandler(int signal){
    ...
    ssrlcv::ptr::value<ssrlcv::Unity<int>> i_nums_cpt = ssrlcv::ptr::value<ssrlcv::Unity<int>>("0_i.uty");
...
int main(int argc, char *argv[]){
  try{
    ...
    i_nums = ssrlcv::ptr::value<ssrlcv::Unity<int>>(nullptr,100,ssrlcv::cpu);
    for(int i = 0; i < 100; ++i){
      i_nums->host.get()[i] = i;
    } 

/**
* \file example_checkpoint_interrupt.cu
* \author  Jackson Parker
* \date    March 4 2020
* \brief Example on the usage of the Unity structure's checkpointing
...
int main(int argc, char *argv[]){
  try{
    ...
    */
    ...
    i_nums = jax::Unity<int>(nullptr,100,jax::cpu);

...
int main(int argc, char *argv[]){
  try{
    ...
    images_vec[0]->id = 0;
    images_vec[0]->camera.size = {100,100};
    ...
    images_vec[1]->id = 1;
    images_vec[1]->camera.size = {100,100};
    ...
    matches->host[0].keyPoints[0].loc = {50.0,50.0}; // at the center!
    matches->host[0].keyPoints[1].loc = {0.0,0.0}; // in the corner

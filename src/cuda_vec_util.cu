...
void remove(std::shared_ptr<ssrlcv::Unity<float2_b>> array){remove(array,check_if_valid<float2_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<float3_b>> array){remove(array,check_if_valid<float3_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<float4_b>> array){remove(array,check_if_valid<float4_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<double2_b>> array){remove(array,check_if_valid<double2_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<double3_b>> array){remove(array,check_if_valid<double3_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<double4_b>> array){remove(array,check_if_valid<double4_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<char2_b>> array){remove(array,check_if_valid<char2_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<char3_b>> array){remove(array,check_if_valid<char3_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<char4_b>> array){remove(array,check_if_valid<char4_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<uchar2_b>> array){remove(array,check_if_valid<uchar2_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<uchar3_b>> array){remove(array,check_if_valid<uchar3_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<uchar4_b>> array){remove(array,check_if_valid<uchar4_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<short2_b>> array){remove(array,check_if_valid<short2_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<short3_b>> array){remove(array,check_if_valid<short3_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<short4_b>> array){remove(array,check_if_valid<short4_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<ushort2_b>> array){remove(array,check_if_valid<ushort2_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<ushort3_b>> array){remove(array,check_if_valid<ushort3_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<ushort4_b>> array){remove(array,check_if_valid<ushort4_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<int2_b>> array){remove(array,check_if_valid<int2_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<int3_b>> array){remove(array,check_if_valid<int3_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<int4_b>> array){remove(array,check_if_valid<int4_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<uint2_b>> array){remove(array,check_if_valid<uint2_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<uint3_b>> array){remove(array,check_if_valid<uint3_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<uint4_b>> array){remove(array,check_if_valid<uint4_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<long2_b>> array){remove(array,check_if_valid<long2_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<long3_b>> array){remove(array,check_if_valid<long3_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<long4_b>> array){remove(array,check_if_valid<long4_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<ulong2_b>> array){remove(array,check_if_valid<ulong2_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<ulong3_b>> array){remove(array,check_if_valid<ulong3_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<ulong4_b>> array){remove(array,check_if_valid<ulong4_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<longlong2_b>> array){remove(array,check_if_valid<longlong2_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<longlong3_b>> array){remove(array,check_if_valid<longlong3_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<longlong4_b>> array){remove(array,check_if_valid<longlong4_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<ulonglong2_b>> array){remove(array,check_if_valid<ulonglong2_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<ulonglong3_b>> array){remove(array,check_if_valid<ulonglong3_b>);}
void remove(std::shared_ptr<ssrlcv::Unity<ulonglong4_b>> array){remove(array,check_if_valid<ulonglong4_b>);}

...
ssrlcv::Unity<unsigned char>* ssrlcv::convertImageToChar(Unity<float>* pixels){
  ...
  dim3 grid = {1,1,1};
  dim3 block = {1,1,1};
  getFlatGridBlock(pixels->numElements,grid,block,(void*)convertToCharImage);
...
ssrlcv::Unity<float>* ssrlcv::convertImageToFlt(Unity<unsigned char>* pixels){
  ...
  dim3 grid = {1,1,1};
  dim3 block = {1,1,1};
  getFlatGridBlock(pixels->numElements,grid,block,(void*)convertToFltImage);
...
void ssrlcv::convertToBW(Unity<unsigned char>* pixels, unsigned int colorDepth){
  ...
  dim3 grid = {1,1,1};
  dim3 block = {1,1,1};
  getFlatGridBlock(numPixels, grid, block,(void*)generateBW);
...
void ssrlcv::convertToRGB(Unity<unsigned char>* pixels, unsigned int colorDepth){
  ...
  dim3 grid;
  dim3 block;
  getFlatGridBlock(numPixels, grid, block,(void*)generateRGB);
